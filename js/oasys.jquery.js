 ...
 * @private
 */
var _execute = function(method, uri, app, body, success, error) {
	var _method = method || $('#request-method').val(), _xMethod = $('#request-x-method').val();
	var _uri = uri || $('#request-uri').val(), _folder = $('#request-x-folder-name').val();
	var _app = app || $('#request-x-app-name').val() || 'oasys';
	var _raw = body || $('#request-body').val();
