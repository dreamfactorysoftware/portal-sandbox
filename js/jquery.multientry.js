...
(function ($, window, document, undefined) {
    ...
    $.fn.multientry = function (options) {
        ...
        return this.each(function () {
            ...
            $('<div class="' + _inputSizeClass + '">' + '<ul class="list-group ' + options.ulClass + ' scroll-pane" id="' +
            ...
            $('<div class="' + options.divClass + '">' +
                ...
                '		<button class="' + options.buttonClass + '" type="button">Add Header</button>' +
                '	</span>' +
    ...
    $.fn.multientry.options = {
        ...
        itemTemplate: '<li class="list-group-item" id="%%item%%"><a href="#">%%item%%<i title="Click to delete" class="fa fa-trash-o pull-right df-multientry-item hide label label-danger"></i></a></li>',
